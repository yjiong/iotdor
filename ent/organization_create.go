...
func (oc *OrganizationCreate) SetFloor(s string) *OrganizationCreate {
	oc.mutation.SetFloor(s)
	return oc
}

// SetNillableFloor sets the "floor" field if the given value is not nil.
func (oc *OrganizationCreate) SetNillableFloor(s *string) *OrganizationCreate {
	if s != nil {
		oc.SetFloor(*s)
	}
	return oc
...
func (oc *OrganizationCreate) SetUnitNo(s string) *OrganizationCreate {
	oc.mutation.SetUnitNo(s)
	return oc
}

// SetNillableUnitNo sets the "unitNo" field if the given value is not nil.
func (oc *OrganizationCreate) SetNillableUnitNo(s *string) *OrganizationCreate {
	if s != nil {
		oc.SetUnitNo(*s)
	}
	return oc
...
func (oc *OrganizationCreate) SetLongitudeAndLatituude(s string) *OrganizationCreate {
	oc.mutation.SetLongitudeAndLatituude(s)
	return oc
}
...
func (oc *OrganizationCreate) SetNillableSummary(s *string) *OrganizationCreate {
	if s != nil {
		oc.SetSummary(*s)
	}
	return oc
...
func (oc *OrganizationCreate) AddDeviceIDs(ids ...int) *OrganizationCreate {
	oc.mutation.AddDeviceIDs(ids...)
	return oc
}

// AddDevices adds the "devices" edges to the Device entity.
func (oc *OrganizationCreate) AddDevices(d ...*Device) *OrganizationCreate {
	ids := make([]int, len(d))
	for i := range d {
		ids[i] = d[i].ID
	}
...
func (oc *OrganizationCreate) createSpec() (*Organization, *sqlgraph.CreateSpec) {
	...
	if value, ok := oc.mutation.Floor(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
	...
	if value, ok := oc.mutation.UnitNo(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
	...
	if value, ok := oc.mutation.LongitudeAndLatituude(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
	...
	if nodes := oc.mutation.DevicesIDs(); len(nodes) > 0 {
